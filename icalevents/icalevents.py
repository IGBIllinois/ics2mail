...
def events(url=None, file=None, string_content=None, start=None, end=None, fix_apple=False, no_recurrence=False):
    """
    ...
    found_events += parse_events(content, start=start, end=end, no_recurrence=no_recurrence)
